...
class CustomersController extends Controller
{
    ...
    public function getIndex(Request $request) {
        ...
        return view('backend.layout.page.customers.index',$data);
    }
    public function getAdd() {
        $data['title'] = 'Add Customers';

        return view('backend.layout.page.customers.add',$data);
    }
    ...
    public function getEdit($id) {
        ...
        return view('backend.layout.page.customers.edit',$data);
    }
    ...
    public function getDetail($id) {
        ...
        return view('backend.layout.page.customers.detail',$data);
    }
